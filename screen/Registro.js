    ...
    return(
        ...
        <Content padder contentContainerStyle = {misEstilos.content}>
            ...
            <CardItem bordered>
                ...
                <Item inlineLabel>
                    <Input placeholder = 'mail' onChangeText = {(email)=> this.setState({email})}/>
                </Item>
                <Item inlineLabel>
                    <Input placeholder = 'user' onChangeText = {(user)=> this.setState({user})}/>
                </Item>
                <Item inlineLabel last>
                    <Input placeholder = 'passwor' onChangeText = {(pass)=> this.setState({pass})}/>
                </Item>
                </Body>
            </CardItem>
